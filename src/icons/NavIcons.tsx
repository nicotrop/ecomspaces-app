...
export function UpArrowIcon({ state }: ArrowState) {
  return (
    <svg
      width="10"
      height="10"
...
export function DownArrowIcon({ state }: ArrowState) {
  return (
    <svg
      width="10"
      height="10"
